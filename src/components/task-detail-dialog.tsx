...
/**
 * TaskDetailDialog — shared presentational task-details modal
 *
 * 📍 src/components/task-detail-dialog.tsx
 *
 * Used by both the company task section and the mentor task section so the two
 * surfaces stay visually consistent (Issue #25). It is purely presentational —
 * callers pass the already-resolved task (and optional loading/error flags); it
...
interface TaskDetailDialogProps {
  open: boolean;
  onClose: () => void;
  task: TaskDetailDialogTask | null | undefined;
  isLoading?: boolean;
  error?: boolean;
  description?: string;
}
...
export function TaskDetailDialog({
  ...
  isLoading = false,
  error = false,
  description = "Full details for this task.",
