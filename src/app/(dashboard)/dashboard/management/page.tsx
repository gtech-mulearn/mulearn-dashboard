...
const MANAGEMENT_ITEMS: ManagementItem[] = [
  ...
  },
  {
    ...
    path: "/dashboard/management/organization/affiliation",
    color: "bg-chart-4/10 text-chart-4",
  },
  {
    icon: RefreshCw,
    ...
    path: "/dashboard/management/organization/organization-transfer",
    color: "bg-chart-5/10 text-chart-5",
  },
  {
    icon: Building2,
  ...
  },
  {
    ...
    path: "/dashboard/management/organization/organizations",
    color: "bg-chart-1/10 text-chart-1",
  },
  {
    icon: CheckCircle,
