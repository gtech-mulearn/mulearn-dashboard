...
export const IGRequestItemSchema = z.object({
  ...
  prerequisites: z.unknown().nullable().optional(),
  career_opportunities: z.unknown().nullable().optional(),
  top_blogs: z.unknown().nullable().optional(),
  people_to_follow: z.unknown().nullable().optional(),
  resource: z.string().nullable().optional(),
  leads: z.unknown().nullable().optional(),
  mentors: z.unknown().nullable().optional(),
