...
> = {
  ...
  competition:     { label: "Competition",       icon: Trophy,    className: "ig-cat-manager" },
  ideathon:        { label: "Ideathon",          icon: Lightbulb, className: "ig-cat-creative" },
  cultural_event:  { label: "Cultural Event",    icon: Gamepad2,  className: "ig-cat-creative" },
  sports_event:    { label: "Sports Event",      icon: Trophy,    className: "ig-cat-maker" },
  community_event: { label: "Community Event",   icon: Users,     className: "ig-cat-maker" },
  expo:            { label: "Expo",              icon: Globe,     className: "ig-cat-manager" },
  networking_event:{ label: "Networking",        icon: Users,     className: "ig-cat-coder" },
