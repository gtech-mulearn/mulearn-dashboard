...
export function InterestGroupCard({ group, gradient }: InterestGroupCardProps) {
  ...
  return (
    <button
      ...
      className="group relative h-[250px] sm:h-[280px] md:h-[300px] w-full cursor-pointer overflow-hidden rounded-[2rem] border border-white/10 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-primary/20 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
    >
      <div
