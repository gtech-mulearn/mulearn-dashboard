        ...
        {filteredLog.map((entry) => (
          ...
          >
            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-center text-center">
              ...
              <h2 className="text-sm text-muted-foreground">Karma</h2>

              {/* Task Name */}
              <div className="mt-5">
                <p className="text-xs text-muted-foreground">Awarded for</p>
                <p className="mt-1 rounded bg-primary/10 px-2 py-1 text-sm font-medium text-primary">
                  #{entry.task_name}
                </p>
              </div>
