...
export const videoTestimonials: VideoTestimonial[] = [
  {
    ...
    label: "Vice Chancellor, Digital University of Kerala",
  },
  {
    name: "Dr Pv Unnikrishnan",
    videoUrl: "Rn2v9mkar4Q",
    label: "Member Secretary, KDISC",
  },
  {
    name: "K. N. Balagopal",
    videoUrl: "XoybSPRL3pw",
    label: "Minister for Finance, Government of Kerala",
  },
  {
    name: "Anoop P Ambika",
    videoUrl: "UcAM0_Kgbn0",
    label: "Chief Executive Officer, Kerala Startup Mission",
  },
  {
    name: "Dr P. K. Biju",
    videoUrl: "tvmqUINECCI",
    label: "Syndicate Member, APJ Abdul Kalam Technological University",
  },
  {
    name: "Dr RAJASREE M S",
    videoUrl: "Kx2lRDjzMMk",
    label: "Vice Chancellor, APJ Abdul Kalam Technological University",
  },
  {
    name: "Garima Mehra & Farish CV",
    videoUrl: "b7u86JWH6ww",
    label: "Google",
  },
  {
    name: "Shri Rajeev J Sebastian",
    videoUrl: "duM15-tOwFo",
    label: "CEO , Alokin Software Pvt Ltd",
  },
  {
    name: "Sangeetha",
